...
**Homepage:** <https://github.com/epmd-edp/javascript-npm-antora.git>
...
* <https://github.com/epmd-edp/javascript-npm-antora.git>
...
| framework | string | `"antora"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"test-appapp"` |  |
